...
1. [`office-documents`](../office-documents/SKILL.md) skill — the brand system and the email rules (section 5).
...
Run both commands and use the result as the `From` identity. Never hardcode a sender — the person running this skill is always the sender.
