...
This prompt deliberately invokes actions that normally require **tool approval**,
...
demo. This prompt handles it automatically: **step 1 reads the current value of
...
6. **Restore the global auto-approve override.** Set
   ...
   thing the prompt does, so the box is left exactly as it was found.
