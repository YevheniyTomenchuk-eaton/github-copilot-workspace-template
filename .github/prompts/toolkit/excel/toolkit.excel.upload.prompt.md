...
```
powershell.exe -ExecutionPolicy Bypass -File .github/scripts/toolkit/sharepoint-upload/upload-to-sharepoint.ps1 -LocalPath "toolkit/excel/YY-MM-DD-HHMM-short-description/workbook.xlsx" -SiteUrl "<site-url>" -TargetFolder "<target-folder>" -CreateFolder
```
