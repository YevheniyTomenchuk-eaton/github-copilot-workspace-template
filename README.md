...
Your onboarding guide — how GitHub Copilot's customization layers (instructions, skills, agents, hooks) work and how to use them in this workspace.
...
Worked examples that show the full pattern end to end — a skill that calls a script and fills a template to generate Office documents (email, presentation, spreadsheet, document). Copy these as the model for your own automations.
...
4. **Customize:** add your own content folders, instructions, skills, and agents. See [Customization files](workspace/using-copilot/customization-files.md) for the naming and placement rules.
...
- **[Customization files](workspace/using-copilot/customization-files.md)** — the six building blocks (instructions, skills, agents, hooks, templates, scripts), folder mirroring, and naming conventions.
- **[Context and commands](workspace/using-copilot/context-and-commands.md)** — how instructions, skills, and agents fit together.
